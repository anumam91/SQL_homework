...
(
-- get actor ids for actors in movie
SELECT actor_id FROM film_actor WHERE film_id IN
(
-- get alone trip film_id
...
-- wanted to double check my last solution using subqueries, which I am more comfortable with
...
SELECT title, COUNT(*) AS 'Rentals' FROM film 
